      ...
      case "select":
          ...
          return (
            <FormGroup>
              ...
              <Input
                type="select"
                value={arg.argument}
                onChange={this._handleArg.bind(this)}
        ...
        return (
          <FormGroup>
            ...
            >
              <option value={null}>Select An Option</option>
              {this.state.data[arg.queryName] &&
                this.state.data[arg.queryName].map(data => {
                  return (
                    <option key={data[arg.key]} value={data[arg.key]}>
                      {data[arg.value]}
                    </option>
                  );
                })}
      ...
      case "objectarray":
        ...
        return (
          <div>
              ...
              <Card>
                <CardBody>
                  <FontAwesome
                    ...
                    onClick={this._removeArgItem.bind(this, i)}
                  />
                  {Object.keys(arg.object).map(key => (
                    <FormGroup>
                      ...
                      <Input
                        type="text"
                        value={a[key]}
                        onChange={this._handleArrayObj.bind(this, key, i)}
                      />
                    </FormGroup>
                  ))}
                </CardBody>
            ...
            <Button color="success" onClick={this._addArgItem.bind(this)}>
              Add Item
            </Button>
          </div>
        );
