...
const PanControls = function (object, domElement) {
  ...
  if (domElement === document)
    console.error(
      'THREE.PanControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.',
    );
  ...
  var pan = (function () {
    ...
    return function pan(deltaX, deltaY) {
      ...
      if (scope.object.isPerspectiveCamera) {
        ...
        console.warn(
          "WARNING: PanControls.js encountered an unknown camera type - pan disabled.",
        );
  ...
  function dollyIn(dollyScale) {
    if (scope.object.isPerspectiveCamera) {
      ...
      console.warn(
        "WARNING: PanControls.js encountered an unknown camera type - dolly/zoom disabled.",
      );
...
PanControls.prototype = Object.create(THREE.EventDispatcher.prototype);
PanControls.prototype.constructor = PanControls;
