  ...
  render() {
    ...
    />*/}
          <group rotation={finalAngle}>
            <IndicatorCircle
              name="yaw"
              rotation={new THREE.Euler(Math.PI / 2, 0, finalAngle.y)}
              color={0xff0000}
            />
            <IndicatorCircle
              name="pitch"
              rotation={new THREE.Euler(finalAngle.x, Math.PI / 2, 0)}
              color={0x0000ff}
            />
            <IndicatorCircle
              name="roll"
              color={0x00ff00}
              rotation={new THREE.Euler(0, 0, finalAngle.z)}
            />
