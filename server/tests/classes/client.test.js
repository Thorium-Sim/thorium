...
describe('Client', () => {
  ...
  test('should throw if called without the \'new\' operator', () => {
    expect(() => { const c = Client(); }).toThrow(/Cannot call a class as a function/);
  });
  ...
  describe('setFlight', () => {
    ...
    test('should reset station and hypercard', () => {
      const c = new Client({station: 'fakeStation', hypercard: 'fakeHypercard'});
      c.setFlight('nonExistingFlightId');
