...
export const FlightStructureMutations = {
  ...
  updateSimulatorInterfaces(rootValue, params, context) {
    App.handleEvent(params, "updateSimulatorInterfaces", context);
  },
  ...
  setSimulatorSpaceEdventuresId(rootValue, params, context) {
    App.handleEvent(params, "setSimulatorSpaceEdventuresId", context);
  },
