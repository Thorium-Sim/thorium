...
export default class Mission {
  ...
  addTimelineStep({
    ...
    this.timeline.push(
      new TimelineStep(timelineStepId || null, {
        name,
        description,
        order,
        timelineItems,
...
export class TimelineStep {
  ...
  order: number;
  timelineItems: TimelineItem[];
  constructor(timelineStepId: string | null, params: Partial<TimelineStep>) {
  ...
  updateTimelineItem(id, timelineItem) {
    ...
    if (!timelineItemInst) throw new Error("Timeline item not found");
