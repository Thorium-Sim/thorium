...
export default [
  {
    ...
    instructions({
      ...
      if (station && (task as Task).station === station.name)
        return reportReplace(
          `${preamble} Admit ${crewmember.rank} ${crewmember.fullName} to the sickbay and perform a full treatment diagnostic.`,
          {
            simulator,
            system,
          },
