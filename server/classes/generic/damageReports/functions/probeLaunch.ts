...
export default (
  ...
  return `${
    preamble ||
    `A probe should be launched to check on the repair status of the ${displayName} system.`
  } Ask the ${stationName} officer to launch a probe. Then have them perform this query:
