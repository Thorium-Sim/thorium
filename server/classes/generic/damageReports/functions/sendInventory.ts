...
export default (
  {inventory, room, preamble}: DamageStepArgs,
  {
    location,
    name,
    displayName = name,
  ...
  return `${
    preamble || `Supplies will be needed to repair the ${displayName} system.`
  } Ask the ${stationName} officer to send the following cargo:
