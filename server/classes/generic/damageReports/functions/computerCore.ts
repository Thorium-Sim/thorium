...
export default (
  ...
  return `${
    preamble ||
    `A user should be created in the computer core to repair the ${displayName} system.`
  } Ask the ${stationName} create a user with the following username and password:
