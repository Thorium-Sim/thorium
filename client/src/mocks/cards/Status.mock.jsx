import {
  STATUS_DEST_QUERY,
  STATUS_DEST_SUB,
} from "@client/cards/Status/components/destination";
import {
  STATUS_ENGINE_QUERY,
  STATUS_ENGINE_SUB,
} from "@client/cards/Status/components/speed";
import {
  STATUS_POP_QUERY,
  STATUS_SIM_SUB,
  STATUS_POP_SUB,
} from "@client/cards/Status/components/population";
import systems from "../data/systems";
import simulators from "../data/simulators";
import {
  STATUS_COOLANT_QUERY,
  STATUS_COOLANT_SUB,
} from "@client/cards/Status/components/coolant";
import {STATUS_DILITHIUM_QUERY} from "@client/cards/Status/components/dilithiumStress";
import {
  STATUS_TARGETING_SUB,
  STATUS_TARGETING_QUERY,
} from "@client/cards/Status/components/targeted";
import {
  STATUS_BATTERY_QUERY,
  STATUS_BATTERY_SUB,
} from "@client/cards/Status/components/battery";
import {
  STATUS_DAMAGE_QUERY,
  STATUS_DAMAGE_SUB,
} from "@client/cards/Status/components/damaged";
import {
  STATUS_ALERT_QUERY,
  STATUS_ALERT_SUB,
} from "@client/cards/Status/components/alertCondition";
import {
  STATUS_STEALTH_QUERY,
  STATUS_STEALTH_SHIELD_SUB,
  STATUS_STEALTH_SUB,
} from "@client/cards/Status/components/stealth";
import {
  STATUS_RADIATION_QUERY,
  STATUS_RADIATION_SUB,
} from "@client/cards/Status/components/radiation";
